...
const DESIGNS = [
  { id: '1', title: 'CHASSIS_GEOMETRY', tag: 'REF_01', desc: '[ WIDE CHASSIS ] 12% LATERAL FLARE', url: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1200' },
